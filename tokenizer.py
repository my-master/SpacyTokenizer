...
class SpacyTokenizer:
    ...
    def __init__(self, disable=None, stopwords=None):
        """
        :param disable: pipeline processors to omit
    ...
    def tokenize(self, data: List[str], ngram_range=(1, 1), batch_size=1000, n_threads=4):
        ...
        :param n_threads: number of threads for parallel computing; doesn't work good
    ...
    def ngramize(self, items, ngram_range=(1, 1)):
        filtered = list(
